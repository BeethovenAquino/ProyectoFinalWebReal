<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ConsultaPago.aspx.cs" Inherits="ProyectoFinalWeb.UI.Consultas.ConsultaPago" %>
        ...
        <table>
            <tr>
                ...
                <td]>
                    ...
                    <strong><asp:Label ID="Label1" runat="server" Text="Desde"></asp:Label></strong>&nbsp
                        </td>
                <td>
                    <asp:TextBox ID="HastaTextBox" TextMode="Date" runat="server" class="form-control" Height="25" Width="175" Text="Hasta"></asp:TextBox>
                </td>
            </tr>
        </table>
    </div>
        ...
        <div class="row">
            <div class="form-row justify-content-center">
                <asp:GridView ID="PrestamoGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        <asp:BoundField DataField="PagoID" HeaderText="FacturaID" />
