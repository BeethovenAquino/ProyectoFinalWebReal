<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ConsultaInversion.aspx.cs" Inherits="ProyectoFinalWeb.UI.Consultas.ConsultaInversion" %>
        ...
        <div class="row">
            ...
            <div style="width: 220px">
                <asp:DropDownList class="form-control" ID="TipodeFiltro" runat="server" for="TipodeFiltro" Width="200px">
                    <asp:ListItem>InversionID</asp:ListItem>
        ...
        <div class="row">
            <div class="form-row justify-content-center">
                <asp:GridView ID="PrestamoGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        <asp:BoundField DataField="InversionID" HeaderText="InversionID" />
